...
# ╔═╡ e4de7669-b69b-41fb-8cd7-ac886b01af35
using Plots

# ╔═╡ 19c16251-2849-4d8e-87da-28ce3c2c3bc6
using DifferentialEquations

# ╔═╡ a3f23ede-91a2-11ec-1aa5-a5acdf4a1c3c
md"""
# Derivadas e Integrais
"""

# ╔═╡ c33a7bbc-ec53-4f3b-8117-ce72d76fd137
md"""
Vamos considerar o caso unidimensional em que a posiçao de uma partícula em no tempo é definida pela função:

$$s(t) = \frac{t^2}{2} + 2t + 5$$
"""

# ╔═╡ 78d7030b-9d22-4b37-97b8-bd7adace6900
s(t) = 0.5*t^2 + 2*t +5

# ╔═╡ fbb4852e-3296-4c34-941a-4f470dd02880
plot(0:0.2:5, s.(0:0.2:5), label=false, xlabel="t(s)", ylabel="s(m)", linewidth=3)

# ╔═╡ f82510cd-b5f8-4118-a269-28eda841a826
md"""
Derivando, encontramos a expressão para a velocidade da partícula.

$$\frac{ds}{dt} = v(t) = t + 2$$
"""

# ╔═╡ 0c81564e-b49b-447e-b93a-56d2ae64e9d2
v(t) = t + 2

# ╔═╡ cc3d607e-4151-40b5-bc1d-6f4503da6435
plot(0:0.2:5, v.(0:0.2:5), label=false, xlabel="t(s)", ylabel="v(m/s)", linecolor="green", linewidth=3)

# ╔═╡ c7e7d6e2-ba31-4be3-95d2-402f8163dc9a
md"""
Derivando novamente, descobrimos que a aceleração é constante e igual a 1 m/s²
"""

# ╔═╡ 90819f44-b245-47f2-bf7e-a89e65a509d3
a(t) = 1

# ╔═╡ bbb12697-b21d-4a2f-8455-60b5bcb78edb
plot(0:0.2:5, a.(0:0.2:5), label=false, xlabel="t(s)", ylabel="a(m/s²)", linecolor="red", linewidth=3, ylim=[0,2])

# ╔═╡ 13a4129a-5e49-467d-8314-f46377eec0a6
md"""
**Podemos percorrer o caminho inverso e integrar a aceleração para recuperar a velocidade, em seguida integrar a velocidade para encontrar a posição (teorema fundamental do cálculo)**

Vamos tentar integrar a aceleração para ver o que acontece. 

$$v₂(t) = \int a(t) dt = \int dt = t$$
"""

# ╔═╡ 27fb501d-1122-48f2-8345-ca138629c090
md"""
Vemos que a expressão final obtida, v₂(t) = t, é diferente da que começamos, v(t) = t + 2
...
Como exemplo, vamos interpretar o modelo epidemiológico SIR.
...
# ╔═╡ 2d3de528-77e1-4345-8553-b1c114d7ad7d
begin
	# Condições iniciais:
	u₀ = [499.0, 1.0, 0.0]
	tspan = [0.0,360.0]
...
# ╔═╡ c5f24dc8-c8c5-41e9-9699-d20cadc1fef5
# Resolvendo problema
sol = solve(prob)

# ╔═╡ 1fb8a34d-4558-4bcd-b2bc-41225476c915
plot(sol)
