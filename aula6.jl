...
# ╔═╡ 7cf6b69d-1e04-48d4-9a5b-ceb52d2c08b3
begin
...
# ╔═╡ 7f6192b5-9ac9-4509-85b2-952d91982233
using LinearAlgebra

# ╔═╡ 6ec7299e-999d-11ec-12df-dd8ddc3abaa9
md"""
# Sistema massa-mola de 1 GDL, com amortecimento

Equação do movimento (vibração livre):
...
Encontrando os autovalores de A, chega-se a:

$λ = \frac{-c \pm \sqrt{c^2-4km}}{2m}$
"""

# ╔═╡ dd6b2525-fd9d-4bad-b3ce-3b6967368212
md"""
## Exemplo

Vamos considerar o caso em que $m = 1\;kg$, $k = 100\;N/m$ e verificar o que ocorre com a variação do amortecimento.

Em cada situação veja o que ocorre com o termo $c^2 - 4km$, no interior da raiz quadrada.
"""

# ╔═╡ 6819d70c-8018-46f1-b394-892deed7c67d
# Sistema de equações diferenciais
function massamola(du, u, p, t)
	du[1] = -(p[2]/p[1])*u[1] -(p[3]/p[1])*u[2]
	du[2] = u[1]
end

# ╔═╡ 7345e84f-b385-43ab-bb95-84d36c3c033d
begin
	m = 1.0
	k = 100.0
	u₀ = [0.0, 1.0]
...
# ╔═╡ 7c565f7e-d8e1-4bac-86d4-42cc8dadc99e
md"""
Coeficiente de amortecimento

$(@bind c Slider(2.0:2.0:40.0))
"""

# ╔═╡ 41c92d3f-1e8d-4ac0-9609-3b540393a316
p = [m,c,k]

# ╔═╡ 4eeeeb49-db2d-404f-95bd-07ab3c0c08b6
# Resolvendo o problema
begin
	prob = ODEProblem(massamola, u₀, tspan, p)
	sol = solve(prob)
	plot(sol,linewidth=2,xaxis="t",label="x [m]", vars=(0,2))
end

# ╔═╡ 2dcc4aff-27d0-4cc2-9452-24f9a975607e
md"""
### Verificando os autovalores da matrix
...
# ╔═╡ d142e88c-3d5a-40d4-96b6-0c3fa74dd849
A = [-p[2]/p[1] -p[3]/p[1];1 0]

# ╔═╡ b425dd0a-db81-4474-8589-0eece741ddfa
eigvals(A)
